        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data kategori sampah</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="{{route('kategori.tambah')}}" class="btn btn-warning mb-3">Tambah kategori sampah</a>
                @if ($errors->any())
                <div class="my-3">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{route('kategori.edit', $item->id_kategori)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pen"></i></a>
